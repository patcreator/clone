        ...
        <form id="loginForm" class="space-y-5">
            ...
            <div class="relative">
                ...
                <input type="password" id="password" name="password" required
                    class="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-green-500 pr-10">
            ...
            <button type="submit"
                class="w-full py-2 px-4 bg-green-600 text-white font-semibold rounded hover:bg-green-700 transition duration-200">
                Login
            </button>
            <div id="loginError" class="text-red-500 text-sm text-center hidden"></div>
        </form>
        <div class="mt-6 flex flex-col items-center space-y-2">
            <a href="./signup" class="text-green-600 hover:underline text-sm">Register</a>
            <a href="./forgot-password" class="text-green-600 hover:underline text-sm">Forgot Password?</a>
        </div>
    </div>
    <script>
        // View/Hide password
