...
include_once '../../../system/cogs/functions.php';$row = fetchData("SELECT * FROM `pdt_sectorcoordinator` WHERE `id` = ?", [$id])[0] ?? null;
if (!$row) { die('Record not found'); }
?>
<div class="max-w-3xl mx-auto mt-8 bg-white p-6 rounded-lg shadow-md"><form id="editpdt_sectorcoordinatorForm" method="POST" action="/update/pdt_sectorcoordinator?id=<?= $id ?>" class="space-y-6">
            <div>
