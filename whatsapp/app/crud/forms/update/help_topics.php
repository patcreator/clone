...
include_once '../../../system/cogs/functions.php';$row = fetchData("SELECT * FROM `help_topics` WHERE `id` = ?", [$id])[0] ?? null;
if (!$row) { die('Record not found'); }
?>
<div class="max-w-3xl mx-auto mt-8 bg-white p-6 rounded-lg shadow-md"><form id="edithelp_topicsForm" method="POST" action="/update/help_topics?id=<?= $id ?>" class="space-y-6">
            <div>
