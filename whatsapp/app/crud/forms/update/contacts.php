...
include_once '../../../system/cogs/functions.php';$row = fetchData("SELECT * FROM `contacts` WHERE `id` = ?", [$id])[0] ?? null;
if (!$row) { die('Record not found'); }
?>
<div class="max-w-3xl mx-auto mt-8 bg-white p-6 rounded-lg shadow-md"><form id="editcontactsForm" method="POST" action="/update/contacts?id=<?= $id ?>" class="space-y-6">
            <div>
            ...
            <div>
                ...
                <input type='text' id='phone' name='phone' required 
                    ...
                    maxlength='50' placeholder="Enter phone" 
