<div class="max-w-3xl mx-auto mt-8 bg-white p-6 rounded-lg shadow-md"><form id="addpdt_districtcoordinatorForm" method="POST" action="/create/pdt_districtcoordinator" class="space-y-6">
                <div>
