<div class="max-w-3xl mx-auto mt-8 bg-white p-6 rounded-lg shadow-md"><form id="addhelp_articlesForm" method="POST" action="/create/help_articles" class="space-y-6">
                <div>
                    <label class='block text-sm font-medium text-gray-700 mb-1' for='id'>id</label>
                    <input type='number' id='id' name='id' required value='299756' 
                        maxlength='20'
                ...
                <div>
                    ...
                    <input type='text' id='category' name='category' required  
                        ...
                        placeholder="Enter category" class='mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md focus:ring focus:ring-blue-200 focus:border-blue-400' />
                </div>
                ...
                <div>
                    <label class='block text-sm font-medium text-gray-700 mb-1' for='is_active'>is_active</label>
                    <input type='number' id='is_active' name='is_active'  value='1' 
                        maxlength='1'
                        
                        placeholder="Enter is_active" class='mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md focus:ring focus:ring-blue-200 focus:border-blue-400' />
                </div>
