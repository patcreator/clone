...
<head>
<meta charset="UTF-8">
<title>help_articles Report</title>
...
<section>
  ...
  <div>
    <table id="reportTable" class="display">
      <thead>
      <tr>
        <th>id</th><th>title</th><th>slug</th><th>category</th><th>content</th><th>keywords</th><th>is_active</th><th>created_at</th><th>updated_at</th><th>status</th>
      </tr>
      </thead>
      <tbody></tbody>
    </table>
...
$(function() {
  ...
  const table = $('#reportTable').DataTable({
    ajax: {
      url: '<?= $path ?>app/crud/reports/api/help_articles.php?ajax=1',
      dataSrc: ''
    },
    columns: [
...
');
    ...
    a.href = url; a.download = 'help_articles-report.csv'; a.click();
  });
});
</script>
