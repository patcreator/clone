...
<head>
<meta charset="UTF-8">
<title>blogs_and_categories Report</title>
...
<section>
  <header style="display:flex;justify-content:space-between;align-items:center;margin-bottom:1rem;">
    <div>
      <h1>blogs_and_categories — Report</h1>
...
$(function() {
  ...
  const table = $('#reportTable').DataTable({
    ajax: {
      url: '<?= $path ?>app/crud/reports/api/blogs_and_categories.php?ajax=1',
      dataSrc: ''
    },
    columns: [
  ...
  $('#exportCSV').on('click', function() {
    ...
    a.href = url; a.download = 'blogs_and_categories-report.csv'; a.click();
  });
});
</script>
