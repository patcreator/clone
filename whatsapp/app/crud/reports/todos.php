...
<section>
  ...
  <div>
    <table id="reportTable" class="display">
      <thead>
      <tr>
        <th>id</th><th>task</th><th>completed</th><th>created_at</th><th>updated_at</th><th>status</th>
      </tr>
      </thead>
      <tbody></tbody>
    </table>
...
$(function() {
  ...
  const table = $('#reportTable').DataTable({
    ajax: {
      url: '<?= $path ?>app/crud/reports/api/todos.php?ajax=1',
      dataSrc: ''
    },
    columns: [
...
');
    ...
    a.href = url; a.download = 'todos-report.csv'; a.click();
  });
});
</script>
