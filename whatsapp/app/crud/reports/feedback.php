...
<section>
  ...
  <div>
    <table id="reportTable" class="display">
      <thead>
      <tr>
        <th>id</th><th>user_id</th><th>name</th><th>email</th><th>subject</th><th>message</th><th>rating</th><th>type</th><th>created_at</th><th>updated_at</th><th>status</th>
      </tr>
      </thead>
      <tbody></tbody>
    </table>
...
$(function() {
  ...
  const table = $('#reportTable').DataTable({
    ajax: {
      url: '<?= $path ?>app/crud/reports/api/feedback.php?ajax=1',
      dataSrc: ''
    },
    columns: [
