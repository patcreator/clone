<?php
// Auto-generated report page for table: pdt_sectorcoordinator
?>
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
<title>pdt_sectorcoordinator Report</title>
...
<section>
  <header style="display:flex;justify-content:space-between;align-items:center;margin-bottom:1rem;">
    <div>
      <h1>pdt_sectorcoordinator — Report</h1>
...
$(function() {
  ...
  const table = $('#reportTable').DataTable({
    ajax: {
      url: '<?= $path ?>app/crud/reports/api/pdt_sectorcoordinator.php?ajax=1',
      dataSrc: ''
    },
    columns: [
      { data: 'id' },
  ...
  $('#exportCSV').on('click', function() {
    ...
    a.href = url; a.download = 'pdt_sectorcoordinator-report.csv'; a.click();
  });
});
</script>
