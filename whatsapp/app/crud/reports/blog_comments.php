...
<head>
<meta charset="UTF-8">
<title>blog_comments Report</title>
...
$(function() {
  ...
  const table = $('#reportTable').DataTable({
    ajax: {
      url: '<?= $path ?>app/crud/reports/api/blog_comments.php?ajax=1',
      dataSrc: ''
    },
    columns: [
      
                { data: 'blog_comment_id' },
  ...
  $('#exportCSV').on('click', function() {
    ...
    a.href = url; a.download = 'blog_comments-report.csv'; a.click();
  });
});
</script>
