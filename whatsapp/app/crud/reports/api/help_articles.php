<?php
// Auto-generated report API for table: help_articles
...
if (isset($_GET['ajax'])) {
    ...
    $sql = "SELECT `id`, `title`, `slug`, `category`, `content`, `keywords`, `is_active`, `created_at`, `updated_at`, `status` FROM `help_articles` WHERE 1";
    $params = [];
    if ($query) {
        $likeParts = [];
    ...
    $allowedSort = ['id','is_active','created_at','updated_at'];
