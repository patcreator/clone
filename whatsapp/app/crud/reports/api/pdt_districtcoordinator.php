<?php
// Auto-generated report API for table: pdt_districtcoordinator
...
if (isset($_GET['ajax'])) {
    ...
    $sql = "SELECT `id`, `fullName`, `email`, `phone`, `password`, `createdDate`, `status`, `Level`, `Location`, `created_at` FROM `pdt_districtcoordinator` WHERE 1";
    $params = [];
    if ($query) {
        $likeParts = [];
