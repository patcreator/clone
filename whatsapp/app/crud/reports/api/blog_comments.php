<?php
// Auto-generated report API for table: blog_comments
...
if (isset($_GET['ajax'])) {
    ...
    if ($query) {
        $likeParts = [];
                ...
                $likeParts[] = "blog_comment_id LIKE ?";
                
                $likeParts[] = "blog LIKE ?";
                
                $likeParts[] = "firstname LIKE ?";
                
                $likeParts[] = "lastname LIKE ?";
                
                $likeParts[] = "Email LIKE ?";
                
                $likeParts[] = "message LIKE ?";
                
                $likeParts[] = "createdDate LIKE ?";
    ...
    $allowedSort = ['blog_comment_id','created_at','updated_at'];
