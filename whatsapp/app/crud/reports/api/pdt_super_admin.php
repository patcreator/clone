<?php
// Auto-generated report API for table: pdt_super_admin
...
if (isset($_GET['ajax'])) {
    ...
    $sql = "SELECT `id`, `fullName`, `email`, `phoneNumber`, `password`, `created_at` FROM `pdt_super_admin` WHERE 1";
    $params = [];
    if ($query) {
        $likeParts = [];
        $likeParts[] = "fullName LIKE ?";
        $likeParts[] = "email LIKE ?";
        $likeParts[] = "phoneNumber LIKE ?";
