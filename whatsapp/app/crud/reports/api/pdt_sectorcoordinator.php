<?php
// Auto-generated report API for table: pdt_sectorcoordinator
...
if (isset($_GET['ajax'])) {
    ...
    $sql = "SELECT `id`, `fullName`, `email`, `phone`, `password`, `createdDate`, `status`, `Level`, `Location`, `created_at` FROM `pdt_sectorcoordinator` WHERE 1";
    $params = [];
    if ($query) {
        $likeParts = [];
