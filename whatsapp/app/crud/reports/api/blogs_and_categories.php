<?php
// Auto-generated report API for table: blogs_and_categories
...
if (isset($_GET['ajax'])) {
    ...
    $sql = "SELECT * FROM `blogs_and_categories`";
    $params = [];
    if ($query) {
        $likeParts = [];
        
                $likeParts[] = "BAC_ID LIKE ?";
    ...
    $allowedSort = ['BAC_ID','created_at','updated_at'];
