<?php
// Auto-generated report API for table: blog_categories
...
if (isset($_GET['ajax'])) {
    ...
    if ($query) {
        $likeParts = [];
                ...
                $likeParts[] = "blog_category_id LIKE ?";
                
                $likeParts[] = "blog_category_name LIKE ?";
                
                $likeParts[] = "blog_category_status LIKE ?";
                
                $likeParts[] = "blog_category_slug LIKE ?";
    ...
    $allowedSort = ['blog_category_id','created_at','updated_at'];
