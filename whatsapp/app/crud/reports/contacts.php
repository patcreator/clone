...
<section>
  ...
  <div>
    <table id="reportTable" class="display">
      <thead>
      <tr>
        <th>id</th><th>name</th><th>phone</th><th>email</th><th>created_at</th><th>updated_at</th><th>status</th>
      </tr>
      </thead>
      <tbody></tbody>
    </table>
...
$(function() {
  ...
  const table = $('#reportTable').DataTable({
    ajax: {
      url: '<?= $path ?>app/crud/reports/api/contacts.php?ajax=1',
      dataSrc: ''
    },
    columns: [
...
');
    ...
    a.href = url; a.download = 'contacts-report.csv'; a.click();
  });
});
</script>
