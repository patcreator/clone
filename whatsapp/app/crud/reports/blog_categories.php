...
<head>
<meta charset="UTF-8">
<title>blog_categories Report</title>
...
$(function() {
  ...
  const table = $('#reportTable').DataTable({
    ajax: {
      url: '<?= $path ?>app/crud/reports/api/blog_categories.php?ajax=1',
      dataSrc: ''
    },
    columns: [
  ...
  $('#exportCSV').on('click', function() {
    ...
    a.href = url; a.download = 'blog_categories-report.csv'; a.click();
  });
});
</script>
