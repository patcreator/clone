<?php
// Auto-generated report page for table: pdt_provincecoordinator
?>
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
<title>pdt_provincecoordinator Report</title>
...
<section>
  <header style="display:flex;justify-content:space-between;align-items:center;margin-bottom:1rem;">
    <div>
      <h1>pdt_provincecoordinator — Report</h1>
...
$(function() {
  ...
  const table = $('#reportTable').DataTable({
    ajax: {
      url: '<?= $path ?>app/crud/reports/api/pdt_provincecoordinator.php?ajax=1',
      dataSrc: ''
    },
    columns: [
      { data: 'id' },
  ...
  $('#exportCSV').on('click', function() {
    ...
    a.href = url; a.download = 'pdt_provincecoordinator-report.csv'; a.click();
  });
});
</script>
