...
<section>
  ...
  <div>
    <table id="reportTable" class="display">
      <thead>
      <tr>
        <th>id</th><th>user_id</th><th>action</th><th>entity_type</th><th>entity_id</th><th>old_value</th><th>new_value</th><th>ip_address</th><th>user_agent</th><th>created_at</th><th>updated_at</th><th>status</th>
      </tr>
      </thead>
      <tbody></tbody>
    </table>
...
$(function() {
  ...
  const table = $('#reportTable').DataTable({
    ajax: {
      url: '<?= $path ?>app/crud/reports/api/history.php?ajax=1',
      dataSrc: ''
    },
    columns: [
...
');
    ...
    a.href = url; a.download = 'history-report.csv'; a.click();
  });
});
</script>
