...
<head>
<meta charset="UTF-8">
<title>search_index Report</title>
...
<section>
  ...
  <div>
    <table id="reportTable" class="display">
      <thead>
      <tr>
        <th>id</th><th>entity_type</th><th>entity_id</th><th>title</th><th>content</th><th>keywords</th><th>url</th><th>created_at</th><th>updated_at</th><th>status</th>
      </tr>
      </thead>
      <tbody></tbody>
    </table>
...
$(function() {
  ...
  const table = $('#reportTable').DataTable({
    ajax: {
      url: '<?= $path ?>app/crud/reports/api/search_index.php?ajax=1',
      dataSrc: ''
    },
    columns: [
...
');
    ...
    a.href = url; a.download = 'search_index-report.csv'; a.click();
  });
});
</script>
