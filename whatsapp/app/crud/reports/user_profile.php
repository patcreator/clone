...
<head>
<meta charset="UTF-8">
<title>user_profile Report</title>
...
<section>
  ...
  <div>
    <table id="reportTable" class="display">
      <thead>
      <tr>
        <th>id</th><th>user_id</th><th>first_name</th><th>last_name</th><th>username</th><th>email</th><th>phone</th><th>avatar_url</th><th>bio</th><th>gender</th><th>date_of_birth</th><th>country</th><th>city</th><th>state</th><th>zip_code</th><th>social_links</th><th>created_at</th><th>updated_at</th><th>status</th>
      </tr>
      </thead>
      <tbody></tbody>
    </table>
...
$(function() {
  ...
  const table = $('#reportTable').DataTable({
    ajax: {
      url: '<?= $path ?>app/crud/reports/api/user_profile.php?ajax=1',
      dataSrc: ''
    },
    columns: [
...
');
    ...
    a.href = url; a.download = 'user_profile-report.csv'; a.click();
  });
});
</script>
