...
';$dir_path='./'; }
    if (is_dir($dir_path)) {
     ...
     ?>
<form class="grid grid-cols-1 gap-2 md:grid-cols-12 bg-gray-50 dark:bg-slate-800 dark:text-gray-100 p-2 shadow-md mb-3 w-full rounded">
    ...
    <div class="col-span-12 md:col-span-4 flex">
            ...
            <div>
            <button class="p-2 md:w-auto w-full bg-red-500 hover:bg-red-700 text-white rounded-md ms-3">Go to</button>
            </div>
    </div>
    <div class="md:col-span-5  col-span-12  md:flex justify-end w-full">
...
<!-- Dropdown menu -->
<div id="dropdownDots'.$key.'" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow border dark:border-gray-600 w-44 dark:bg-gray-700 dark:divide-gray-600">
...
$(".this-container").prepend(`
        <div id="alert-additional-content-5" class="p-4 border border-gray-300 my-4 rounded-lg bg-gray-50 dark:border-gray-600 dark:bg-gray-800" role="alert">
          ...
          <div class="flex">
            <a href="/PDT0/${path}.zip" class="text-white zip-download-delete bg-gray-700 hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-xs px-3 py-1.5 me-2 text-center inline-flex items-center dark:bg-gray-600 dark:hover:bg-gray-500 dark:focus:ring-gray-800">
